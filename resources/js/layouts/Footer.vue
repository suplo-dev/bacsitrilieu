    ...
    <footer class="bg-blue-teal-gradient relative px-4 py-24 text-white sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
        <div class="flex flex-col md:flex-row">
            ...
            <div v-if="$page.props.categories.category_footer" class="mt-8 w-full lg:mx-4 lg:mt-0 lg:w-1/6">
                <h5 class="font-semibold uppercase tracking-wider">{{ $page.props.categories.category_footer.name }}</h5>
                <ul class="mt-4" v-for="(category, index) in $page.props.categories.category_footer.children" :key="`category_footer_${index}`">
                    <li class="mt-2">
                        <a :href="category.slug" title="" class="opacity-75 hover:opacity-100">{{ category.name }}</a>
                    </li>
                </ul>
            </div>

            <div class="mt-8 w-full lg:mx-4 lg:mt-0 lg:w-2/6 lg:pr-8">
                <h5 class="font-semibold uppercase tracking-wider">Thông tin liên hệ</h5>
                <ul class="mt-4">
                    <li>
                        <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                            ...
                            <span class="ml-3"> 19/10 ấp 4 Xã Phú Xuân, huyện Nhà Bè, TP. HCM </span>
                        </a>
                    </li>
                    <li class="mt-4">
                        <span class="block flex items-center">
                            ...
                            ></span>
                            <span class="ml-3">T2 - CN: 9:00 - 19:00<br /></span>
                        </span>
                    </li>
                    <li class="mt-4">
                        <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                            ...
                            <span class="ml-3"> 0902 749 781 </span>
                        </a>
                    </li>
                    <li class="mt-4">
                        <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                            ...
                            <span class="ml-3"> support@bacsitrilieu.com </span>
                        </a>
                    </li>
                </ul>
            </div>

            <div class="mt-8 w-full lg:mx-4 lg:mt-0 lg:w-1/6">
                <h5 class="font-semibold uppercase tracking-wider">theo dõi tại</h5>
                <ul class="mt-4 flex">
                    <li>
                ...
                <p class="mt-12 text-xs">© 2025 BACSITRILIEU.COM</p>
            </div>
        </div>
    </footer>
</template>
